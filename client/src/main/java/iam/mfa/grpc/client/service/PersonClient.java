...
public class PersonClient {
    ...
    public Flux<String> sendPersonWithRetry(String id) {
        final var personRequest = PersonRequest.newBuilder()
                .setId(id)
                .setName("hamma")
                .setAge(23)
